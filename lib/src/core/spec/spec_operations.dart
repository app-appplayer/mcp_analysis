...
abstract interface class SpecOperations {
  Future<List<AnalysisSpec>> listSpecs({String? search, int? limit, int? offset});
  ...
  Map<String, dynamic> resolveParameters(AnalysisSpec spec, Map<String, dynamic> overrides);
}

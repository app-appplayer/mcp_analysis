...
- **Functions and Transforms** — 34 built-in functions: statistics (incl. moments, PCA, hypothesis tests), DSP (FFT w/ phase, Welch PSD, spectrogram, cepstrum, harmonics/THD, cross-PSD/coherence/FRF, filters, peaks, resample, envelope), timeseries (ACF auto-period, cross-correlation, CUSUM, Holt-Winters, Savitzky-Golay w/ derivatives, Lomb-Scargle for uneven sampling), interpolation, and a built-in domain layer (vibration ISO 10816, HRV, EEG bands) — plus pluggable custom functions and transforms.
